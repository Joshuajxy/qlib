...
class ModelRunner:
    def _init_qlib(self, exp_folder_name, crypto_data_path="~/.qlib/qlib_data/crypto_data"):
        # init qlib
        # GetData().qlib_data(exists_skip=True)  # We don't want stock data for crypto
        qlib.init(
            provider_uri=crypto_data_path,
            region="crypto",
            exp_manager={
    ...
    def run(
        ...
        universe="",
        exclude=False,
        qlib_uri: str = "/home/joshua/code2/qlib",
        ...
        """
        self._init_qlib(exp_folder_name, crypto_data_path="~/.qlib/qlib_data/crypto_data")
